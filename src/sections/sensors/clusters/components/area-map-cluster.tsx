...
type AreaMapClusterProps = {
    onSendFunction: (markerPosition: google.maps.LatLngLiteral | null, polygon: google.maps.LatLngLiteral[]) => void;
    isLoading: boolean;
    isMobile: boolean;
};

export const AreaMapCluster = ({ onSendFunction, isLoading, isMobile }: AreaMapClusterProps) => {
    const { markerPosition, polygonCoordinates } = useDrawingManager();
